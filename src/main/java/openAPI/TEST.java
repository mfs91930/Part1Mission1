...
public class TEST {
    static int list_total_count;
    public static void main(String[] args) throws IOException {
        SQLiteControl sqlM = new SQLiteControl();
//        sqlM.selector();
        DistanceCalculator disCal = new DistanceCalculator();
        double lat1 = 37.587653;
        double lon1 = 126.908676;
        double lat2 = 37.580688;
        double lon2 = 126.901350;
        double distance = disCal.haversine(lat1, lon1, lat2, lon2);
        System.out.println("Distance: " + distance + " KM");
//
//        double dis = disCal.distance(lat1, lon1, lat2, lon2);
...
//        sqlM.makeDB(jsonTotalCnt);
//        sqlM.insert(sb.toString());
